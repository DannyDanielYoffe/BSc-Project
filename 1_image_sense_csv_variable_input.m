...
i_min = 1e-18; % [A] (1aA)
max_photo_current = 170e-12; % [A] (170pA)
i_max = 4 * max_photo_current;
sizing_factor = 1/255;
...
variable_block = {'variable','vdd', '1.8', 'enabled','' ,'' ;
                  ...
                  'variable','c_pd_int',    '8.58f', 'enabled','' ,'';   %    Emulated PD Capacitance (WBCAPD cell)
                  'variable','c_pd_ext',    '19.5f', 'enabled','' ,'';
...
writecell (data,'simulation_parameters_input_image_sense_15by15_currents_v2.csv');
