...
%       (tg, rst, sf_bias, rs, out) , pixel SO connected to noConn (lable "NC")
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
control{4,2} = rs;
control{5,2} = col;
 writecell(control, 'pixel_control_16x16.xls'); %remove comma at the end of line
